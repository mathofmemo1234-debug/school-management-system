...
export const STANDARD_SUBJECT_QUOTAS = [
  ...
  { subject: 'العلوم / Science / الفيزياء / الكيمياء / الأحياء', periodsPerClass: 4, standardTeacherLoad: 20 },
  { subject: 'الدراسات الإسلامية والقرآن الكريم', periodsPerClass: 4, standardTeacherLoad: 22 },
  { subject: 'المهارات الرقمية والحاسب والذكاء الاصطناعي', periodsPerClass: 2, standardTeacherLoad: 22 },
  { subject: 'الدراسات الاجتماعية والمواطنة', periodsPerClass: 2, standardTeacherLoad: 22 },
  { subject: 'التربية الفنية', periodsPerClass: 2, standardTeacherLoad: 24 },
...
export const DEFAULT_BRANCH_BUILDINGS_SEED = [
  {
    buildingName: 'المبنى الرئيسي وقسم البنين - المسار الأهلي',
    code: 'BLD-BOYS-NAT-01',
    track: 'national',
    gender: 'boys',
    ...
    areaSqMeters: 4500,
    condition: 'ممتاز',
    facilities: ['science_lab', 'computer_lab', 'sports_gym', 'football_field', 'library', 'prayer_hall', 'clinic'],
    notes: 'مجهز بأحدث الشاشات التفاعلية وشبكات الألياف الضوئية'
  },
  {
    buildingName: 'مبنى قسم البنات - المسار الأهلي والدولي',
    code: 'BLD-GIRLS-ALL-02',
    track: 'national',
    gender: 'girls',
    stages: ['kindergarten', 'primary', 'middle', 'high'],
    floors: 3,
    totalRooms: 40,
    activeClassrooms: 28,
    capacity: 800,
    areaSqMeters: 5200,
    condition: 'ممتاز',
    facilities: ['science_lab', 'computer_lab', 'sports_gym', 'theater', 'library', 'prayer_hall', 'cafeteria', 'clinic'],
    notes: 'استقلالية وخصوصية تامة مع مدخل خاص وتجهيزات ذكية'
  },
  {
    buildingName: 'مبنى الدبلومة الأمريكية والمسار الدولي (بنين)',
    code: 'BLD-BOYS-INTL-03',
    track: 'international',
    gender: 'boys',
    stages: ['middle', 'high'],
    floors: 2,
    ...
    areaSqMeters: 2800,
    condition: 'ممتاز',
    facilities: ['science_lab', 'computer_lab', 'sports_gym', 'football_field', 'library'],
    notes: 'مختبرات STEM متقدمة ومعامل لغات متخصصة'
  }
];
